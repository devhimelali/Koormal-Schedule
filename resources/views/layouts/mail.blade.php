...
<div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#F6F6F6; padding: 30px 0 40px 0">
    <!--[if gte mso 9]>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0">
                                                                <img
                                                                    src="https://ewucbci.stripocdn.email/content/guids/CABINET_c18f327a7910b5ceed2d3aea7ebb97b51bd89f3604057a6a719ff95c43c17f51/images/4emuslogo.png"
                                                                    alt="" width="170" class="img-9986"
                                                                    style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0;border-radius:0">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0">
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                    &copy; {{ date('Y') }} 4EMUS Schedule. All rights
                                                                    reserved.
                                                                </p>
                                                            </td>
                                                        </tr>
