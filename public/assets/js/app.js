!(function () {
    ...
    function S() {
        ...
        !t ||
            ...
            ((n = document.createElement("ul")).innerHTML =
                '<a href="index.html" class="logo"><img src="assets/images/4emus.png" alt="" height="22"></a>'),
            Array.from(
                document
    ...
    function J() {
        ...
        t &&
            300 <
                (t = (t = t.querySelector(".nav-item .active"))
                    ? t.offsetTop
                    : 0) &&
                      ...
                      Array.from(t).forEach(function (e) {
                          ...
                          e.querySelector("h6")
                              ...
                              Array.from(
                                  ...
                                  0 ==
                                  e.querySelectorAll(".notify-item.d-block")
                                      .length
                                      ? (e.querySelector(
                                            ".notification-title"
                                        ).style.display = "none")
                ...
                a.addEventListener("click", (e) => {
                    ...
                    M.hasAttribute("data-bs-theme") && "auto" !== t
                        ...
                        M.classList.toggle(
                            "mode-auto",
                            "true" ===
                                sessionStorage.getItem("data-layout-auto")
                        );
                });
            }),
            M.classList.toggle(
    ...
    function C(e) {
        var t = 0,
            a =
                (Array.from(e.getElementsByClassName("product")).forEach(
                    function (e) {
                        Array.from(
        ...
        (e.querySelector(".cart-subtotal").innerHTML = u + t.toFixed(2)),
            ...
            (e.querySelector(".cart-discount").innerHTML =
                "-" + u + n.toFixed(2));
    }
    function $(e) {
        var t, a, n, o, l;
        e.closest(".product") &&
            ...
            (t || t.getElementsByClassName("product-price")) &&
                Array.from(t.getElementsByClassName("product-price")).forEach(
                    function (e) {
        ...
        Array.from(b).forEach(function (e) {
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((t = {}),
                  ...
                  n["data-default-date"] &&
                      ((t.defaultDate =
                          n["data-default-date"].value.toString()),
                      (t.dateFormat = n["data-date-format"].value.toString())),
